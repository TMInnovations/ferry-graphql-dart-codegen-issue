...
class _$GMeReq extends GMeReq {
  ...
  _$GMeReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GMeReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(operation, 'GMeReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GMeReq', 'executeOnListen');
  }
